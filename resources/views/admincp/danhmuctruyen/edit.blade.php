...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Cập nhập danh mục truyện</div>
                    @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('danhmuctruyen.update', [$danhmuc->id]) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $danhmuc->tendanhmuc }}"
                                    onkeyup="ChangeToSlug()" id="slug" name="tendanhmuc" aria-describedby="emailHelp"
                                    placeholder="Tên danh mục....">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Slug danh mục</label>
                                <input type="text" class="form-control" value="{{ $danhmuc->slug_danhmuc }}"
                                    id="convert_slug" name="slug_danhmuc" aria-describedby="emailHelp"
